...
class HrUpdate(models.Model):
    ...
    def _create_work_contacts(self):
        # Se il context chiede esplicitamente di NON creare il partner,
        # restituiamo un recordset vuoto → Odoo NON crea nulla.
        return False
    ...
    def action_open_employees(self):
        ...
        return {
            ...
            'context': {
                ...
                'default_home_address_id': self.id,
                'default_skip_work_contact': True,
            },
